...
template <typename Dtype>
class PesuDropoutLayer : public NeuronLayer<Dtype> {
 public:
  explicit PesuDropoutLayer(const LayerParameter& param)
      : NeuronLayer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "PesuDropout"; }
...
class SReLULayer : public NeuronLayer<Dtype> {
 ...
 protected:
  ...
  Blob<Dtype> threshold_buffer_;
  Blob<Dtype> bp_diff_buffer_;
  Blob<Dtype> bottom_memory_;

  float threshold_lr;
  int iter;
  int showvalue;
  float variance_recover;
  bool stop_updata;
};

template <typename Dtype>
class BDropoutLayer : public NeuronLayer<Dtype> {
 public:

  explicit BDropoutLayer(const LayerParameter& param)
      : NeuronLayer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "BDropout"; }
 ...
 protected:
  ...
  unsigned int updata_stride_;
  float p_lr_;
  float lamda_lr_;
};

template <typename Dtype>
class SDropoutLayer : public NeuronLayer<Dtype> {
 public:

  explicit SDropoutLayer(const LayerParameter& param)
      : NeuronLayer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "SDropout"; }
